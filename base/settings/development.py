...
GOOGLE_DEV_CLIENT_ID = os.environ.get("GOOGLE_DEV_CLIENT_ID")
GOOGLE_DEV_CLIENT_SECRET = os.environ.get("GOOGLE_DEV_CLIENT_SECRET")
GOOGLE_DEV_REDIRECT_URI = os.environ.get("GOOGLE_DEV_REDIRECT_URI")
