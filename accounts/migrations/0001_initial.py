    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('acquaintance', 'Acquaintance'), ('close_friend', 'Close Friend'), ('best_friend', 'Best Friend')], default='acquaintance', max_length=20)),
                ('is_one_sided', models.BooleanField(default=False)),
                ('notes', models.TextField(blank=True)),
                ('account1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='friendships_as_account1', to=settings.AUTH_USER_MODEL)),
                ('account2', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='friendships_as_account2', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='account',
